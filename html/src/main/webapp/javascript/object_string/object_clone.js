...
//복사.
let obj2 = new Object();
let copyObj = Object.assign({}, originObj); //새로운객체, 복사할 객체
...
s1.friends = [{name: '김영식', phone: '010-1212-1313', age: 20}
              ,{name:'홍명식', phone: '010-1313-1212', hobbies: ['독서','수영']}
              ];
